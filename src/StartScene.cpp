...
void StartScene::m_updateUI()
{
	...
	/*if (ImGui::SliderFloat("Time Factor", &m_time, 0.000001f, 0.20f, "%.1f"))
	{

	}
	if (ImGui::SliderFloat("Time Accumulation Factor", &m_Atime, 0.000001f, 0.20f, "%.1f"))
	{
